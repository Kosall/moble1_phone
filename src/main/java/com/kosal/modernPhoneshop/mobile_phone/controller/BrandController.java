...
public class BrandController {
	...
	/*
	 * @GetMapping public ResponseEntity<?> getBrands(@RequestParam Map<String,
	 * String> params) {
	 * 
	 * Page<Brand> brands = service.getBrands(params); PageDTO dto=new
	 * PageDTO(brands);
	 * 
	 * return ResponseEntity.ok(dto);
	 * 
	 ...
	 */
	/*
	 * @GetMapping public ResponseEntity<?>getAll(){ List<BrandDTO> list =
	 * service.getBrands().stream() .map(br->BrandMapper.INSTANCE.toBrandDTO(br))
	 * .toList(); return ResponseEntity.ok(list); }
	 */
